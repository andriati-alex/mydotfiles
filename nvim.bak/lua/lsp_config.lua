...
local ls_servers = { "clangd", "rust_analyzer", "jedi_language_server", "ruff_lsp", "ts_ls", "lua_ls", "gopls",
    "terraformls", "ltex" }

-- Ensure the servers above are installed
require("mason-lspconfig").setup({ ensure_installed = ls_servers, automatic_installation = true })
