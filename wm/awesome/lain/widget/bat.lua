...
local icons_path = os.getenv("HOME") .. "/.config/awesome/misc_icons"
...
local function factory(args)
    ...
    bat_notification_critical_preset = {
        ...
        timeout = 10,
        font    = "Roboto 16",
        icon    = icons_path .. "/empty_batteryicon.png",
        border_width = 2,
        border_color = "#d54466",
        fg      = "#FF0000",
        bg      = "#1a1a1a"
    ...
    bat_notification_low_preset = {
        ...
        timeout = 10,
        font    = "Roboto 16",
        icon    = icons_path .. "/low_batteryicon.png",
        border_width = 2,
        border_color = "#d54466",
        fg      = "#ee8822",
        bg      = "#1a1a1a"
    ...
    bat_notification_charged_preset = {
        ...
        font    = "Roboto 16",
        icon    = icons_path .. "/full_batteryicon.png",
        timeout = 10,
        border_width = 2,
        border_color = "#d54466",
        fg      = "#bbbbbb",
